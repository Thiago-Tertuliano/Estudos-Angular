    ...
    <div class="shell">
      <aside class="sidebar">
        ...
        <nav class="nav">
          ...
          <a routerLink="/products" routerLinkActive="active" class="nav-item">Produtos</a>
          <a routerLink="/clients" routerLinkActive="active" class="nav-item">Clientes</a>
          <a routerLink="/proposals" routerLinkActive="active" class="nav-item">Propostas</a>
        </nav>
